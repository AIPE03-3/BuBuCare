...
10. [資料庫設計](#資料庫設計)
11. [系統監控與營運](#系統監控與營運)
12. [Data Flywheel](#data-flywheel)
...
這一段記錄問題如何被定位與解決，也是 [Data Flywheel](#data-flywheel)
所描述的迴路在本專案的第一個實際案例。
...
只是不再有事件產生。而「沒有事件」與「沒有人發生意外」在外觀上完全相同。
...
意外事件偵測模型有一個無法迴避的性質：**在實驗室資料集上的表現無法代表現場表現**。
