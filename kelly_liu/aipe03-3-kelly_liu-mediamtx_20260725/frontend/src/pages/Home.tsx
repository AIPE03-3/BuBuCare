...
export function Home() {
  ...
  const selectedCameraPath =
    selectedCamera?.id === 3
      ? 'my_camera_tapo'
      : selectedCamera?.id === 11
        ? 'iphone_camera'
        : null;
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="flex flex-col gap-6 lg:col-span-2">
          ...
          <div className="relative flex min-h-[280px] w-full items-center justify-center rounded-2xl bg-[var(--bg-surface-2)] text-center text-sm text-[var(--text-muted)]">
            {selectedCamera && (
            ...
            {selectedCamera && selectedCameraPath ? (
              <div className="w-full">
                <LiveCameraStream
                  cameraName={`${selectedCamera.zone}・${selectedCamera.name}`}
