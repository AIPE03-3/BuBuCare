...
| P3 | 通報單自動草稿 | 2 | Q7 | — |
| P4 | 主動學習樣本篩選 | 1.5 | P1 | ❌ **已做完又移除 2026-08-10** |
| P5 | 事件問答助手 | 3 | P0 | — |
| | **合計** | **17.5** | | MVP=11 |
...
## P4 — 主動學習樣本篩選（1.5 人日）【❌ 已做完又移除】

> **2026-08-10 整期移除**，見 [`docs/CHANGELOG-STAGES.md`](../../docs/CHANGELOG-STAGES.md) 第 15 項。
> 以下列次保留：其他文件會引用「P4」，而且「做完、上線、再拆掉」本身就該留下痕跡。
> 拆掉的原因不是做壞了，是 4.1 的驗收標準漏了一件事 —— 收錄格式相容既有下游目錄，
> 但**沒有標註的圖進不了 `ai/prepare_dataset.py`**，1037 筆樣本一筆都沒能回訓。
